...
def generate_markdown(python_script, file_name, request, URL, ENABLE_CREATE_KNOWLEDGE, knowledge_name):
    """
    ...
    try:
        ...
        logger.error("=> An unknown error occurred during MARKDOWN document generation.")
        return dumps(
            {
                "error": {
                    "message": str(e)
